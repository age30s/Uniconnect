...
import{getOrganizations, getOrganizationsByStuId, getOrganizationById, getStudents, getFriendsById} from "../ProfileBuilder/script.js"
import { openNav, appendMsg, closeNav, closeForm } from "../ChatTab/chattab.js";
...
document.addEventListener("DOMContentLoaded", function () {
    console.log("TEST")
    document.getElementById('message-ic').addEventListener('click', openNav);
