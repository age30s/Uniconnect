...
async function addStudentInfo(name, age, major, college_yr, organizations, friends, avatar){
...
window.change_image = function change_image(){
    document.getElementById("new_avatar").src = document.getElementById("input-file").value;
...
window.submission_check = function submission_check(){
    ...
    if (name_field.length < 1){
        ...
        if (pronoun_field.length < 1){
            alert("you must enter your pronouns");
        }
        else{
            if (age_field.length < 1){
                alert("you must enter your age");
            }
            else{
                if (major_field.length < 1){
                    alert("you must enter your major");
                } 
                else{
                    if (year_field.length < 1){
                        alert("you must enter your year");
                    }
                    else{
                      console.log("values", name_field, age_field, major_field, year_field);
                      addStudentInfo(name_field, age_field, major_field, year_field, [], [], "../mainPage/images/person.png").then(()=>( window.location.href = "interests.html"));
                    }
                }
            }
        }
